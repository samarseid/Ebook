...
const AudioPlayer = () => {
  ...
  const parts = [
    {
      title: "1-qism",
      src: "/audios/7gdxfmBMJKkWiPvJ2R7C+1VqTEHoVd-E.m4a",
    },
    {
      title: "2-qism",
      src: "/audios/L9C4yVwRUbCebE2HRJ0J+EmHQXkTPEzs.m4a",
    },
    {
      title: "3-qism",
      src: "/audios/WfFT9kqqrSZhdBq263Zd+zF0zGhB2IFs.m4a",
    },
  ];
  ...
  return (
    <div className="audiobook-container">
      ...
      <div className="cover">
        <img src="images/81ANaVZk5LL._SL1500_.jpg" alt="atomic-habits" />
      </div>
