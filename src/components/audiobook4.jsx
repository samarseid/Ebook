...
const AudioPlayer = () => {
  ...
  const parts = [
    {
      title: "1-qism",
      src: "/audios/1984 Part 1, Chapter 1 _ Audiobook.mp3",
    },
    {
      title: "2-qism",
      src: "/audios/1984 Part 1 Chapter 2 _ Audiobook.mp3",
    },
    {
      title: "3-qism",
      src: "",
  ...
  return (
    <div className="audiobook-container">
      ...
      <div className="cover">
        <img src="images/9780452262935_p0_v6_s600x595.jpg" alt="1984-picture" />
      </div>
